...
Miss_mods$`Mississippi Flyway1`$removed_covs
Miss_mods$`Mississippi Flyway2`$removed_covs
Miss_mods$`Mississippi Flyway3`$removed_covs
Miss_mods$`Mississippi Flyway4`$removed_covs

# Inspect occurence model fits
Miss_mods$`Mississippi Flyway1`$occurrence_spec
Miss_mods$`Mississippi Flyway1`$occurrence_sens
Miss_mods$`Mississippi Flyway2`$occurrence_spec
Miss_mods$`Mississippi Flyway2`$occurrence_sens
Miss_mods$`Mississippi Flyway3`$occurrence_spec
Miss_mods$`Mississippi Flyway3`$occurrence_sens
Miss_mods$`Mississippi Flyway4`$occurrence_spec
Miss_mods$`Mississippi Flyway4`$occurrence_sens

# Inspect abundance model fits
Miss_mods$`Mississippi Flyway1`$abund_Rsquared
Miss_mods$`Mississippi Flyway2`$abund_Rsquared
Miss_mods$`Mississippi Flyway3`$abund_Rsquared
Miss_mods$`Mississippi Flyway4`$abund_Rsquared
...
View(Miss.abund.mod4$direct_coefs)
