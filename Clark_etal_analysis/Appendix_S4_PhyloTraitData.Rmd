...
Use these diet and foraging trait datasets to calculate a Gower's distance matrix. Because these are proportional variables, we use the `prep.fuzzy` argument to creating the mixed variable distance coefficient
```{r eval = FALSE}
