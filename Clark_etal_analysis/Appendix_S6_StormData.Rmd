...
This appendix describes how to extract data on storm disturbances by county across time. These variables can be accessed in the `BBS.occurrences` library using `data('Site.descriptors')`.  
```{r eval = FALSE}
