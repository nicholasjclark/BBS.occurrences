...
Add the rarity and diveristy metrics to the migration dataset and save in the analysis folder. This dataframe can be accessed in the `BBS.occurrences` library using `data('Bird.traits')`.
```{r eval = FALSE}
