...
#' derived indices of species' habitat use and nesting behaviour (extracted from the
#' Land Condition Trend Analysis Avian Database), diet and habitat diversities
#' (calculated as a Shannon index using data in the EltonTraits database),
#' clutch size (extracted from the global avian life
...
#'
#' @format A \code{data.frame} object with 303 rows and 13 columns
#'
#' @docType data
