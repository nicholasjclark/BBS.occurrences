#' Compiled data on avian species abundances at NA BBS sites from
#' 2003 to 2009.
#'
#'
...
#' entire workflow is shown in the \code{BBS_data_compiling.R} script. Names were then
...
#' abundances of 303 avian species (stored in columns) across sites.  Row order
#' matches the row orders in the \code{Site.descriptors} and \code{BBS.occurrences} datafiles
#'
#' @docType data
